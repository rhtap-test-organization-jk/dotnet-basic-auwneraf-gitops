...
export ROX_CENTRAL_ENDPOINT="central-tssc-acs.apps.cluster-pts2w.pts2w.sandbox5322.opentlc.com:443"
...
export GITOPS_REPO_URL=https://github.com/rhtap-test-organization-jk/dotnet-basic-auwneraf-gitops
...
export COSIGN_PUBLIC_KEY="LS0tLS1CRUdJTiBQVUJMSUMgS0VZLS0tLS0KTUZrd0V3WUhLb1pJemowQ0FRWUlLb1pJemowREFRY0RRZ0FFYjJIbURYamJBc3hBYUFGSExGOHZ3TzFMVU9sQgpLN2w4RHdMZEhwQkRRR0JxZThsbWF3bXQzcDcvVUVoMG1tMm1ONktLMFpWUmkxMzdBN3hwamJDV29nPT0KLS0tLS1FTkQgUFVCTElDIEtFWS0tLS0tCg=="
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-tssc-tas.apps.cluster-pts2w.pts2w.sandbox5322.opentlc.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-tssc-tas.apps.cluster-pts2w.pts2w.sandbox5322.opentlc.com}
